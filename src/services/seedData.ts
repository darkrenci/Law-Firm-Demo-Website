...
export const initialAttorneys: Attorney[] = [
  {
    ...
    portraitUrl: '/assets/atty-levy-lalusis.svg',
    homeCardImageUrl: '/assets/atty-levy-lalusis.svg',
    homeModalImageUrl: '/assets/atty-levy-lalusis.jpg',
    partnerPageImageUrl: '/assets/atty-levy-lalusis.svg',
  ...
  },
  {
    ...
    portraitUrl: '/assets/atty-diosdado-lalusis.svg',
    homeCardImageUrl: '/assets/atty-diosdado-lalusis.svg',
    homeModalImageUrl: '/assets/atty-diosdado-lalusis.jpg',
    partnerPageImageUrl: '/assets/atty-diosdado-lalusis.svg',
  ...
  },
  {
    ...
    portraitUrl: '/assets/atty-leo-lalusis.svg',
    homeCardImageUrl: '/assets/atty-leo-lalusis.svg',
    homeModalImageUrl: '/assets/atty-leo-lalusis.jpg',
    partnerPageImageUrl: '/assets/atty-leo-lalusis.svg',
...
export const initialNews: NewsItem[] = [
  ...
  },
  {
    ...
    content: 'Our Real Estate & Infrastructure Practice Group, led by Founding Partner Atty. Levy John L.V. Lalusis and Founding Partner Atty. Leo Anselmo L.V. Lalusis, advised the concessionaire on closing financial documentation, right-of-way indemnity agreements, and sovereign guarantees for the 48-billion infrastructure initiative.',
    date: '2026-08-14',
    status: 'published',
    featuredImage: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=1200&q=80',
  },
...
export const initialConsultations: ConsultationRequest[] = [
  {
    ...
    privacyConsent: true,
    status: 'scheduled',
    internalNotes: 'Initial conflict check cleared on Sept 12. Lead Partner assigned: Atty. Levy John Lalusis. Zoom link generated and dispatched to client.',
...
export const initialMedia: MediaItem[] = [
  ...
  {
    id: 'med-atty-levy',
    name: 'Atty. Levy John L.V. Lalusis – Founding Partner Official Portrait',
    url: '/assets/atty-levy-lalusis.svg',
    fileType: 'image',
    format: 'SVG',
    sizeBytes: 15400,
    category: 'portrait',
    altText: 'Atty. Levy John L.V. Lalusis, Founding Partner · Corporate Regulatory Compliance, Tax & Real Estate',
    createdAt: '2026-09-01',
  },
  {
    id: 'med-atty-diosdado',
    name: 'Senior Partner Atty. Diosdado Anselmo Q. Lalusis – Official Portrait',
    url: '/assets/atty-diosdado-lalusis.svg',
    fileType: 'image',
    format: 'SVG',
    sizeBytes: 16200,
    category: 'portrait',
    altText: 'Senior Partner Atty. Diosdado Anselmo Q. Lalusis, Senior Advisory Counsel & Academician (40 Years Experience)',
    createdAt: '2026-09-01',
  },
  {
    id: 'med-atty-leo',
    name: 'Atty. Leo Anselmo L.V. Lalusis – Founding Partner Official Portrait',
    url: '/assets/atty-leo-lalusis.svg',
    fileType: 'image',
    format: 'SVG',
    sizeBytes: 15800,
    category: 'portrait',
    altText: 'Atty. Leo Anselmo L.V. Lalusis, Founding Partner · High-Profile Litigation & Criminal Defense',
    createdAt: '2026-09-01',
  },
  {
    id: 'med-1',
...
export const initialActivityLogs: ActivityLog[] = [
  {
    id: 'log-1',
    userId: 'usr-1',
    userName: 'Atty. Levy John L.V. Lalusis',
    ...
    sections: [
      ...
      },
      {
        ...
        content: {
          ...
          body: 'Lalusis & Partners was established under the visionary guidance of Senior Partner Atty. Diosdado Anselmo Q. Lalusis, alongside Founding Partners Atty. Levy John L.V. Lalusis and Atty. Leo Anselmo L.V. Lalusis, following distinguished careers in government legal divisions, high-profile prosecution, regulatory oversight, and trial litigation. Their goal was deliberate: to build a firm where intellectual depth takes precedence over volume, and where every client receives direct partner engagement. Over the years, the firm has grown into one of the country’s most respected full-service practices while maintaining the intimacy, agility, and bespoke discretion of a specialized legal institution.',
          imageUrl: '/assets/group-picture.svg',
        },
      },
      {
